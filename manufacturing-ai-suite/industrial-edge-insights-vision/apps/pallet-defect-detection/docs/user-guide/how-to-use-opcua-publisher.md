...
5. To use docker based deployment follow this [document](./get-started.md). Or to use helm based deployment follow this [document](./how-to-deploy-using-helm-charts.md)
