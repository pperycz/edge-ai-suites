...
Please see sample applications such as [Pallet Defect Detection](apps/pallet-defect-detection), [Weld Porosity](apps/weld-porosity) and [Wind Turbine Anomaly Detection](wind-turbine-anomaly-detection/) to learn utilizing these workflows to accelerate your solution development for AI in manufacturing use cases.
